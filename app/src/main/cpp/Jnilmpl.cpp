...
#define NATIVE_RENDER_CLASS_NAME    "com/example/ndkopengldemo/MyNativeRender"
#define NATIVE_BG_RENDER_CLASS_NAME "com/example/ndkopengldemo/egl/NativeEglRender"

#ifdef _cplusplus
extern "C" {
#endif
/*
 *  Class :     com_example_ndkopengldemo_MyNativeRender
 *  Method:     native_Init
 *  Signature:  ()V
 */
...
/************************************************************************************************************/
/*
 *  Class :     com_example_ndkopengldemo_egl_NativeBgRender
...
static JNINativeMethod g_BgRenderMethods[] = {
        ...
        {"native_EglRenderUnInit",      "()V",          (void *)(native_BgRenderUnInit)},
};
