...
public class MyNativeRender {
    ...
    public native void native_SetParamsInt(int parmType, int value0, int value1);

    public native void native_SetParamsFloat(int parmType, float value0, float value1);
