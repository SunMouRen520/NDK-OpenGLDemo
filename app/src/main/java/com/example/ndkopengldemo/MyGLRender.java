...
import static com.example.ndkopengldemo.MyNativeRender.SAMPLE_TYPE_SET_TOUCH_LOC;
import static com.example.ndkopengldemo.MyNativeRender.SAMPLE_TYPE_SET_GRAVITY_XY;
...
public class MyGLRender implements GLSurfaceView.Renderer {
    ...
    public void init() { mNativeRender.native_Init(); }

    public void unInit() {mNativeRender.native_UnInit(); }
    ...
    public void setAudioData(short[] audioData) { mNativeRender.native_SetAudioData(audioData);}

    public int getSampleType() { return mSampleType;}
